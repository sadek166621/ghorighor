                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                                <div class="single-product shop-mar-bottom">
                                                    ...
                                                    <div class="product-img-wrap">
                                                        <a class="product-img" href="{{route('product-details',['id'=>$category->id])}}"> <img src="{{asset($category->main_image)}}" class="spclimg" style="height:277px;width: 264px" alt="product-image" /></a>
                                                    ...
                                                    <div class="product-info text-center">
                                                        <div class="product-content">
                                                            <a href="{{route('product-details',['id'=>$category->id])}}"><h3 class="pro-name">{{$category->product_name}}</h3></a>
                                                            <div class="pro-price">
