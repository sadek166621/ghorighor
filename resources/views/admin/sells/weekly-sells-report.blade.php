    ...
    <div class="row animated fadeInRight">
        <div class="panel">
            <div class="panel-content">
                <div class="row">
                    <div class="col-md-5">
                        <h5 class="mb-lg ">Weekly Sells Report</h5>
                    </div>
                    <div  class="col-md-7">
                        <input type="text" class="form-control num1" name="total_fees" value="Last Week Sells: TK.{{$totals}}" id="totalAmount" readonly style="border: none; font-size: 25px; font-weight: bold;color: red;background: none">
                    </div>
                </div>
            </div>
        </div>
